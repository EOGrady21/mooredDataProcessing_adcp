...
oceNc_create <- function(adp, name,  metadata){
 ...
 FillValue <- 1e35
  ...
  ncatt_put(ncout, "EWCT", "valid_max", '')
  ncatt_put(ncout, "EWCT", "valid_min",'' )
  ncatt_put(ncout, "EWCT", "valid_range", "")
  ncatt_put(ncout, "NSCT", "valid_max",'' )
  ncatt_put(ncout, "NSCT", "valid_min", '')
  ncatt_put(ncout, "NSCT", "valid_range", "")
  ncatt_put(ncout, "VCSP", "valid_max",'')
  ncatt_put(ncout, "VCSP", "valid_min", '')
  ncatt_put(ncout, "VCSP", "valid_range", "")
  ncatt_put(ncout, "ERRV", "valid_max",'')
  ncatt_put(ncout, "ERRV", "valid_min", '')
  ncatt_put(ncout, "ERRV", "valid_range", "")
  ncatt_put(ncout, "BEAM_01", "valid_min", '')
  ncatt_put(ncout, "BEAM_01", "valid_range", "")
  ncatt_put(ncout, "BEAM_01", "valid_max", '' )
  ncatt_put(ncout, "BEAM_02", "valid_min", '' )
  ncatt_put(ncout, "BEAM_02", "valid_range", "")
  ncatt_put(ncout, "BEAM_02", "valid_max", '')
  ncatt_put(ncout, "BEAM_03", "valid_min", '')
  ncatt_put(ncout, "BEAM_03", "valid_range", "")
  ncatt_put(ncout, "BEAM_03", "valid_max",'' )
  ncatt_put(ncout, "BEAM_04", "valid_min",'')
  ncatt_put(ncout, "BEAM_04", "valid_range", "")
  ncatt_put(ncout, "BEAM_04", "valid_max",'' )
  ncatt_put(ncout, "PGDP_01", "valid_min", '')
  ncatt_put(ncout, "PGDP_01", "valid_range", "")
  ncatt_put(ncout, "PGDP_01", "valid_max",'' )# eg min 25 % good
  ncatt_put(ncout, "PGDP_02", "valid_min", '')
  ncatt_put(ncout, "PGDP_02", "valid_range", "")
  ncatt_put(ncout, "PGDP_02", "valid_max", '')
  ncatt_put(ncout, "PGDP_03", "valid_min",' ')
  ncatt_put(ncout, "PGDP_03", "valid_range", "")
  ncatt_put(ncout, "PGDP_03", "valid_max",'' )
  ncatt_put(ncout, "PGDP_04", "valid_min",'')
  ncatt_put(ncout, "PGDP_04", "valid_range", "")
  ncatt_put(ncout, "PGDP_04", "valid_max", '')
  ncatt_put(ncout, "hght", "valid_min", '')
  ncatt_put(ncout, "hght", "valid_range", "")
  ncatt_put(ncout, "hght", "valid_max",'')
  ncatt_put(ncout, "D", "valid_min", "")
  ncatt_put(ncout, "D", "valid_range", "")
  ncatt_put(ncout, "D", "valid_max", "")
  ncatt_put(ncout, "Tx", "valid_min", '')
  ncatt_put(ncout, "Tx", "valid_range", "")
  ncatt_put(ncout, "Tx", "valid_max", '')
