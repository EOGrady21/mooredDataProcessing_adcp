...
This is an example of a quality controlled data set with little to no error, most data sets will have some curve to the lines as the bin number increases the echo intensity will decrease. 
